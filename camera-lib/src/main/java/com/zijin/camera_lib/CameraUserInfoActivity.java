...
public class CameraUserInfoActivity extends AppCompatActivity {
    ...
    public static void start(Activity activity, String baseUrl, String authorization) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_user_info);
    ...
    private void startCameraThread() {
        ...
        cameraThread.start();
        cameraHandler = new CameraHandler(cameraThread.getLooper(), authorization);
    }
...
//        matrix.postRotate(180);
    ...
    private class CameraHandler extends Handler {
        public CameraHandler(Looper looper , String authorization) {
            super(looper);
        }
    ...
    private class MessageHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == STATUS_FINDING) {
                ...
                Toast.makeText(CameraUserInfoActivity.this, message, Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(CameraUserInfoActivity.this, "权限被拒绝，在使用摄像头前必须先授予权限", Toast.LENGTH_LONG).show();
        }
    }
}
